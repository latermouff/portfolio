let timelineElements = [
    ...
    },
    {
        ...
        coordinator: "Carolina Palma Naveira-Cotta, COPPE/UFRJ",
        latermoMember: "Kleber Marques Lisboa",
        teamMembers: "Carolina Palma Naveira-Cotta, Renato Machado Cotta, Marcelo José Colaço, Abdul Orlando Cárdenas Gómez, Carlos Reuther, Pedro Reuther, Lucas Pimenta dos Santos Monteiro",
    ...
    {
        id: 9,
        title: "HYDRON Project: Hydrate Removal Using In Situ Heat Generation System with Passive Control",
        location: "Fluminense Federal University (UFF)",
        laboratory: "Laboratory of Thermal Sciences (Latermo), TEM/PGMEC/UFF",
        coordinator: "Cesar Cunha Pacheco, UFF",
        latermoMember: "Cesar Cunha Pacheco, Isabela Florindo Pinheiro, Leandro Alcoforado Sphaier",
        teamMembers: "Cesar Cunha Pacheco, Isabela Florindo Pinheiro, Leandro Alcoforado Sphaier, Lisiane Veiga Mattos, Rita de Cássia Colman Simões, Marcio da Silveira Carvalho, Bruna Costa Leopércio, Vítor Fernandes Egger, João Magnus Bailuni de Bragança",
        description: "The main objective of this project is to develop and validate an operational protocol for the removal of hydrate blockages in oil and gas pipelines. This protocol involves the use of in situ heat generation processes triggered by exothermic chemical reactions. The steady and controlled release of heat through these mechanisms enables effective and safe blockage removal operations.",
        abstract: "The formation of hydrates in pipelines is a significant operational challenge and a major cost factor for the oil and gas industry. These hydrates—crystalline compounds formed from water and hydrocarbons—typically develop at temperatures between 2 and 12°C and pressures ranging from 30 to 100 bar. They can obstruct pipelines and increase internal corrosion, thereby reducing the service life of the infrastructure. An effective solution for removing these blockages involves the use of in situ heat generation systems based on exothermic chemical reactions. Such reactions not only release heat but also generate solutes that inhibit further hydrate formation, aiding in their dissociation. However, the thermal energy released by these reactions can potentially damage pipelines, especially those with polymeric layers. This project proposes the development of a laboratory-scale demonstration unit (TRL 4) to simulate hydrate formation conditions and test various reactions documented in the literature, assessing both their effectiveness and associated risks. In addition, a computational simulation software will be developed to model flow and heat transfer within pipelines. These simulation tools will evaluate hydrate formation and removal using the proposed methodologies for controlling exothermic reactions in in situ heat generation systems. Application scenarios will be numerically assessed to optimize operational parameters, leading to the establishment of an operational protocol. Based on these results, a specialized cloud-based software (SaaS) will be developed to determine optimal operating conditions, making the solution easily accessible to industry professionals.",
        deliverables: ["A laboratory-scale demonstration unit (TRL 4) will be developed, capable of reproducing hydrate formation conditions.", "Various reactions documented in the literature will be tested to evaluate the risk-effectiveness relationship and identify the most viable option.", "Temperature-responsive microcapsules containing an alkaline solution will be developed for the passive moderation of in situ heat generation reactions (TRL 3).", "A computational simulation software will be developed to model flow and heat transfer in affected pipelines, as well as the decomposition of hydrate blockages.", "Application scenarios for in situ heat generation will be numerically assessed using computational simulations to determine the optimal combination of operational parameters.", "Based on the results above, an operational protocol for in situ heat generation will be created, listing, ranking, and defining acceptable ranges for operational parameters.", "A dedicated software tool will be developed to determine the optimal operating conditions, tailored to an operational scenario of interest to PRIO. This cloud-hosted, web-accessible software (SaaS) will be designed for use by platform professionals in their day-to-day operations."],
        trl: 4,
        company: "PRIO via ANP",
        buttonText: "View Details",
        date: "2025-present",
        icon: "logo_prio",
        imageFolder: "hydron",
